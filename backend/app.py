...
def request_huggingface_general_answer(question: str) -> str | None:
    prompt = (
        ...
        "Se a pergunta for conceitual, explique de forma clara, curta e completa.\n"
        "Limite sua resposta a no maximo 4 frases curtas.\n"
        "Nao escreva introducoes longas.\n"
        "Nao repita a pergunta.\n"
        "Finalize a resposta sem cortar no meio da frase.\n"
